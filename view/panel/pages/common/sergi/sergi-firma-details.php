        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Sergi Firması Bilgileri</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Sergi Firması</a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-nowrap">
                                        ...
                                        foreach (getProducts(3) as $item) {
                                            ...
                                            ?>
                                            <tr>
                                                <td scope="row"><?= $item['name_' . $SiteLang] ?>
                                                </td>

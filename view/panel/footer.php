...
<!-- sortablejs -->
<script src="view/panel/assets/libs/sortablejs/Sortable.min.js"></script>

<!-- nestable init js -->
<script src="asasasview/panel/assets/js/pages/nestable.init.js"></script>

<script>
    const sort = new Sortable(multiDragDemo, {
    ...
    function pagesortlist(ulid) {
        var mylist = [];
        $("#" + ulid + " > card").each(function () {
            mylist.push({
                "id": $(this).attr("data-id")
            });
        })

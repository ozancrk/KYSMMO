                    ...
                    <div class="card-body">
                        ...
                        <table id="buttons-datatables" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                            ...
                            <?php foreach (listBildiriler() as $Paper):
                                ...
                                if(!in_array($Paper['id'],stringToArray(getUserMeta($_SESSION['UserID'],'bildiri')))){
                                    continue;
                                }
                            ...
                            <tr>
                                ...
                                <td><?=$Paper['title']?></td>
                                <td><?php echo bildiriStatus($Paper['status'],$SiteLang); ?></td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="<?=urlCreate('bildiri/hakem-bildiri-details?paperID='.$Paper['id'])?>" class="dropdown-item edit-item-btn"><i

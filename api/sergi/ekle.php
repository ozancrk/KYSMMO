...
switch ($requestMethod) {
    case 'POST':
        ...
        if (!userCheck($v['username'])) {
            ...
            $userID = $db->update('users')->where('username', $v['username'])->set(['sergi' => 1]);
        ...
        echo pageReturn(array('operation' => 'redirect', 'location' => 'panel/sergi/sergi-firma-details?ID='.$userID , 'data' => $v));

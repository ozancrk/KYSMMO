                                                    ...
                                                    'elements' =>
                                                        array(
                                                            array(
                                                                ...
                                                                'id' => 'id',
                                                                'name' => 'status',
                                                                'label' => bildiriStatus($paperMeta['status'], $SiteLang),
                                                                'value' => $paperMeta['status'],
                                                                'optionValue' => 'id',
                                                                'optionText' => $SiteLang,
                                                                'option' => $db->from('bildiri_status')->where('timeline', 0)->all()
                                                            ),
                                                            array('type' => 'hidden', 'name' => 'paperID', 'value' => $_GET['paperID'],), array('type' => 'hidden', 'name' => 'islem', 'value' => 'status',), array('type' => 'hidden', 'name' => 'postUrl', 'value' => 'bildiri/bildiriUpdate',))));
                                            ?>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
                                </div>
